pragma Priority_Specific_Dispatching(FIFO_Within_Priorities, 5, 30);
...
procedure mixedscheduling is
   ...
   Task_3: T(3, 5, Warm_Up_Time, 600, 100, 600);
   Task_4: T(4, 1, Warm_Up_Time, 1200, 100, 1200);
   Task_5: T(5, 2, Warm_Up_Time, 1200, 100, 1200);
   Task_6: T(6, 3, Warm_Up_Time, 1200, 100, 1200);
