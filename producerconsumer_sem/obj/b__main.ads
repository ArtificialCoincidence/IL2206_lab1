...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#87961c22#;
   ...
   u00051 : constant Version_32 := 16#cd2959fb#;
   pragma Export (C, u00051, "ada__numericsS");
   u00052 : constant Version_32 := 16#09924dd9#;
   pragma Export (C, u00052, "ada__real_timeB");
   u00053 : constant Version_32 := 16#69ea8064#;
   pragma Export (C, u00053, "ada__real_timeS");
   u00054 : constant Version_32 := 16#2281c1c8#;
   pragma Export (C, u00054, "system__taskingB");
   u00055 : constant Version_32 := 16#34147ee0#;
   pragma Export (C, u00055, "system__taskingS");
   u00056 : constant Version_32 := 16#fde20231#;
   pragma Export (C, u00056, "system__task_primitivesS");
   u00057 : constant Version_32 := 16#352452d1#;
   pragma Export (C, u00057, "system__os_interfaceB");
   u00058 : constant Version_32 := 16#b9c37c0a#;
   pragma Export (C, u00058, "system__os_interfaceS");
   u00059 : constant Version_32 := 16#769e25e6#;
   pragma Export (C, u00059, "interfaces__cB");
   u00060 : constant Version_32 := 16#467817d8#;
   pragma Export (C, u00060, "interfaces__cS");
   u00061 : constant Version_32 := 16#64ad9f76#;
   pragma Export (C, u00061, "interfaces__c__extensionsS");
   u00062 : constant Version_32 := 16#b870d14d#;
   pragma Export (C, u00062, "system__os_constantsS");
   u00063 : constant Version_32 := 16#7a0a06a1#;
   pragma Export (C, u00063, "system__task_primitives__operationsB");
   u00064 : constant Version_32 := 16#1951cab5#;
   pragma Export (C, u00064, "system__task_primitives__operationsS");
   u00065 : constant Version_32 := 16#89b55e64#;
   pragma Export (C, u00065, "system__interrupt_managementB");
   u00066 : constant Version_32 := 16#1a73cd21#;
   ...
   u00068 : constant Version_32 := 16#30f7f088#;
   pragma Export (C, u00068, "system__multiprocessorsS");
   u00069 : constant Version_32 := 16#2b2125d3#;
   pragma Export (C, u00069, "system__os_primitivesB");
   u00070 : constant Version_32 := 16#0fa60a0d#;
   pragma Export (C, u00070, "system__os_primitivesS");
   u00071 : constant Version_32 := 16#e0fce7f8#;
   pragma Export (C, u00071, "system__task_infoB");
   u00072 : constant Version_32 := 16#8841d2fa#;
   pragma Export (C, u00072, "system__task_infoS");
   u00073 : constant Version_32 := 16#1036f432#;
   pragma Export (C, u00073, "system__tasking__debugB");
   u00074 : constant Version_32 := 16#de1ac8b1#;
   pragma Export (C, u00074, "system__tasking__debugS");
   u00075 : constant Version_32 := 16#fd83e873#;
   pragma Export (C, u00075, "system__concat_2B");
   u00076 : constant Version_32 := 16#0afbb82b#;
   pragma Export (C, u00076, "system__concat_2S");
   u00077 : constant Version_32 := 16#2b70b149#;
   pragma Export (C, u00077, "system__concat_3B");
   u00078 : constant Version_32 := 16#032b335e#;
   pragma Export (C, u00078, "system__concat_3S");
   u00079 : constant Version_32 := 16#4e0ce0a1#;
   pragma Export (C, u00079, "system__crtlS");
   u00080 : constant Version_32 := 16#273384e4#;
   pragma Export (C, u00080, "system__img_enum_newB");
   u00081 : constant Version_32 := 16#6917693b#;
   pragma Export (C, u00081, "system__img_enum_newS");
   u00082 : constant Version_32 := 16#9dca6636#;
   pragma Export (C, u00082, "system__img_lliB");
   u00083 : constant Version_32 := 16#19143a2a#;
   pragma Export (C, u00083, "system__img_lliS");
   u00084 : constant Version_32 := 16#3cdd1378#;
   pragma Export (C, u00084, "system__unsigned_typesS");
   u00085 : constant Version_32 := 16#6ec3c867#;
   ...
   u00111 : constant Version_32 := 16#af2a8e9e#;
   ...
   u00114 : constant Version_32 := 16#47a91c6b#;
   pragma Export (C, u00114, "system__finalization_rootS");
   u00115 : constant Version_32 := 16#e4774a28#;
   pragma Export (C, u00115, "system__os_libB");
   u00116 : constant Version_32 := 16#d8e681fb#;
   pragma Export (C, u00116, "system__os_libS");
   u00117 : constant Version_32 := 16#2a8e89ad#;
   pragma Export (C, u00117, "system__stringsB");
   u00118 : constant Version_32 := 16#684d436e#;
   pragma Export (C, u00118, "system__stringsS");
   u00119 : constant Version_32 := 16#f5c4f553#;
   pragma Export (C, u00119, "system__file_control_blockS");
   u00120 : constant Version_32 := 16#f8537e45#;
   pragma Export (C, u00120, "semaphoresB");
   u00121 : constant Version_32 := 16#248bdb06#;
   pragma Export (C, u00121, "semaphoresS");
   u00122 : constant Version_32 := 16#9fcf5d7f#;
   pragma Export (C, u00122, "system__tasking__protected_objectsB");
   u00123 : constant Version_32 := 16#15001baf#;
   pragma Export (C, u00123, "system__tasking__protected_objectsS");
   u00124 : constant Version_32 := 16#3b415298#;
   pragma Export (C, u00124, "system__soft_links__taskingB");
   u00125 : constant Version_32 := 16#e939497e#;
   ...
   u00128 : constant Version_32 := 16#92cd7102#;
   pragma Export (C, u00128, "system__tasking__protected_objects__entriesB");
   u00129 : constant Version_32 := 16#7daf93e7#;
   ...
   u00155 : constant Version_32 := 16#09db6ec1#;
   pragma Export (C, u00155, "system__val_unsS");
   u00156 : constant Version_32 := 16#69297ce2#;
   pragma Export (C, u00156, "system__tasking__stagesB");
   u00157 : constant Version_32 := 16#bfc55b2f#;
